...
export declare const UComment: import('../../util').SFCWithInstall<import("vue").DefineComponent<{
    ...
    emit: {
        (e: "submit", content: string, parentId: number | null, finish: (comment: import("./interface").CommentApi) => void): void;
    ...
    like: (id: number) => void;
    reply: import("./interface").ReplyParam;
    ...
    CommentList: import("vue").DefineComponent<{
        ...
        ReplyBox: import("vue").DefineComponent<{
            ...
            replyInject: import("./interface").ReplyParam;
            replyMore: () => void;
