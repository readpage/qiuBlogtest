...
exports.paginationProps = Object.assign(Object.assign({}, _mixins_1.useTheme.props), { simple: Boolean, page: Number, defaultPage: {
    ...
    }, 'onUpdate:page': [Function, Array], onUpdatePage: [Function, Array], 'onUpdate:pageSize': [Function, Array], onUpdatePageSize: [Function, Array], 
    /** @deprecated */
        ...
        return ((0, vue_1.h)("div", { ref: "selfRef", class: [
            ...
            this.displayOrder.map((part) => {
                switch (part) {
                    ...
                    case 'size-picker': {
                        return !simple && showSizePicker ? ((0, vue_1.h)(select_1.NSelect, { internalShowCheckmark: false, size: selectSize, placeholder: "", options: pageSizeOptions, value: mergedPageSize, disabled: disabled, theme: mergedTheme.peers.Select, themeOverrides: mergedTheme.peerOverrides.Select, onUpdateValue: handleSizePickerChange })) : null;
                    }
                    case 'quick-jumper':
